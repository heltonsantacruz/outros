...
<div class="titulo">
    <bean:message key="title.cadastro.cliente"/>
</div>
...
<html:form focus="nome" action="/clienteAction.event" >
	<script type="text/javascript">
            ...
            function adicionar() { 
                action = '<html:rewrite page="/clienteAction.event?operacao=adicionar"/>';
            ...
            function atualizaMunicipios(){
             	action = '<html:rewrite page="/clienteAction.event?operacao=carregarMunicipios"/>';
                document.forms[0].action = action;
                document.forms[0].submit();   
            }
