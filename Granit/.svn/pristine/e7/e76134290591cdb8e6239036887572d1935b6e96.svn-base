...
public class Constantes {
	...
	/**
	 * Código da mensagem de erro de inserção no banco de dados.
	 */
	public static final String MSG_ERRO_INSERCAO = "MSG_ERRO_INSERCAO";
	
	/**
	 * Código da mensagem de erro de atualização no banco de dados.
	 */
	public static final String MSG_ERRO_ATUALIZACAO = "MSG_ERRO_ATUALIZACAO";
	
	/**
	 * Código da mensagem de erro de remoção no banco de dados.
	 */
	public static final String MSG_ERRO_REMOCAO = "MSG_ERRO_REMOCAO";
	
	/**
	 * Código da mensagem de erro de consulta no banco de dados.
	 */
	...
	/**
	 * Lista municípios ordenados pelo nome.
	 */
	public static final String NAMEDQUERY_LISTA_MUNICIPIOS = "listaMunicipios";
	
	/**
	 * Parâmetro "sigla", a sigla do estado. Lista municípios de um estado ordenados pelo nome.
	 * */
	...
	//remoção de fornecedor com sucesso
	...
	public static final String VALOR_DE_VENDA_INVALIDO = " O valor informado nas formas de pagamento está DIFERENTE do valor da Venda.";
	...
	public static String OBS1 = "Venda/Saída/IdVenda/usuarioX";
	public static String OBS2 = "Pedido/Entrada/IdPedido/usuarioX";
	public static String OBS3 = "Pedido/Saída/IdPedido/usuarioX/Cancelamento de pedido";
	...
	public static String OBS6 = "Criação inicial/Entrada/usuarioX";
	public static String OBS7 = "Alteração de produto sem historico de entrada/saida registrado/Entrada/usuarioX";
	public static String OBS8 = "Alteração de produto com historico de entrada/saida registrado/Entrada/usuarioX";
	public static String OBS9 = "Alteração de produto com historico de entrada/saida registrado/Saida/usuarioX";
	public static String OBS10 = "Venda/Entrada/IdVenda/usuarioX/Alteração de status para pendente";
}
