...
/* Cadastro de usuários. Pelo menos um usuário deve ser criado inicialmente */
...
insert into perfil (idPerfil,descricao,nome) values(2,'Usuário padrão', 'Padrão') ;
 ...
 * Para as funcionalidades de login não há restrição entre admin e padrão. Por isso que só precisa 
 * do registro com operação = null*/
...
INSERT INTO funcionalidade(idFuncionalidade, actionPath, nome, operacao) VALUES(101, '/usuarioAction', 'Cadastro de Usuários', null) ;
INSERT INTO funcionalidade(idFuncionalidade, actionPath, nome, operacao) VALUES(102, '/usuarioAction', 'Cadastro de Usuários', 'abrir') ;
INSERT INTO funcionalidade(idFuncionalidade, actionPath, nome, operacao) VALUES(103, '/usuarioAction', 'Cadastro de Usuários', 'cancelarIncluir') ;
INSERT INTO funcionalidade(idFuncionalidade, actionPath, nome, operacao) VALUES(104, '/usuarioAction', 'Cadastro de Usuários', 'adicionar') ;
INSERT INTO funcionalidade(idFuncionalidade, actionPath, nome, operacao) VALUES(105, '/usuarioAction', 'Cadastro de Usuários', 'abrirConsulta') ;
INSERT INTO funcionalidade(idFuncionalidade, actionPath, nome, operacao) VALUES(106, '/usuarioAction', 'Cadastro de Usuários', 'processarConsulta') ;
INSERT INTO funcionalidade(idFuncionalidade, actionPath, nome, operacao) VALUES(107, '/usuarioAction', 'Cadastro de Usuários', 'voltarDetalhar') ;
INSERT INTO funcionalidade(idFuncionalidade, actionPath, nome, operacao) VALUES(108, '/usuarioAction', 'Cadastro de Usuários', 'processarExcluir') ;
INSERT INTO funcionalidade(idFuncionalidade, actionPath, nome, operacao) VALUES(109, '/usuarioAction', 'Cadastro de Usuários', 'abrirAlterar') ;
INSERT INTO funcionalidade(idFuncionalidade, actionPath, nome, operacao) VALUES(110, '/usuarioAction', 'Cadastro de Usuários', 'cancelarAlterar') ;
INSERT INTO funcionalidade(idFuncionalidade, actionPath, nome, operacao) VALUES(111, '/usuarioAction', 'Cadastro de Usuários', 'processarAlterar') ;
INSERT INTO funcionalidade(idFuncionalidade, actionPath, nome, operacao) VALUES(112, '/usuarioAction', 'Cadastro de Usuários', 'detalhar') ;
...
/* Associação de  funcionalidades -- Perfils Inicio */
...
/* As operações de usuários só são utilizadas pelo Admin*/
...
/* Associação de  funcionalidades -- Perfils Fim */
